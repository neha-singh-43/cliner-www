...
export const metadata: Metadata = {
  title: "Cliner — Clean Mac Apps Completely in 1-Click | Just $9 One-Time",
  description:
    "Dragging apps to Trash leaves gigabytes of hidden junk on your Mac. Cliner removes apps and all their hidden leftovers completely. Fast, safe, and only $9 for life.",
  ...
  openGraph: {
    ...
    description:
      "Reclaim gigabytes of hidden storage. Drag an app to the trash and Cliner removes all residual files in seconds. Only $9 for lifetime access.",
    images: [
      {
        url: "/app-icon.png",
        width: 1024,
